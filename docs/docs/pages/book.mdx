...
Written for [HyperBEAM v0.9-FINAL](https://github.com/permaweb/HyperBEAM/releases/tag/v0.9-FINAL). Every chapter has a hands-on tutorial, and each module links to its full API reference.
:::
...
| L5 | [JS Smart Contract Platform](/book/build5) | Master-level: JavaScript execution via WASM/QuickJS |
