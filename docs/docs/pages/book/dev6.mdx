...
> 📖 Reference: [dev_wasm](/src/dev_wasm)
...
> 📖 Reference: [dev_wasi](/src/dev_wasi)
...
> 📖 Reference: [dev_wasm](/src/dev_wasm) | [dev_lua](/src/dev_lua) | [dev_wasi](/src/dev_wasi) | [dev_cu](/src/dev_cu)
...
1. **Payment** — Metering and economics ([Tutorial](/book/dev7))
2. **Authentication** — Identity and signatures ([Tutorial](/book/dev8))
3. **Arweave** — Permanent storage ([Tutorial](/book/dev9))
