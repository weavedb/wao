...
> 📖 Reference: [dev_simple_pay](/src/dev_simple_pay)
...
> 📖 Reference: [dev_faff](/src/dev_faff)
...
> 📖 Reference: [dev_p4](/src/dev_p4) | [dev_simple_pay](/src/dev_simple_pay) | [dev_faff](/src/dev_faff)
...
1. **Authentication** — Identity and signatures ([Tutorial](/book/dev8))
2. **Arweave & Data** — Permanent storage ([Tutorial](/book/dev9))
3. **Full Device Reference** — All 77 devices ([Reference](/devices))
