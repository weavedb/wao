...
> 📖 Reference: [hb_beamr](/src/hb_beamr)
...
> 📖 Reference: [hb_beamr_io](/src/hb_beamr_io)
...
Save this as `src/test/test_wasm.erl`:
...
1. **WASM Devices** — HyperBEAM devices that run WASM ([dev_wasm](/src/dev_wasm))
2. **WASI Support** — System interface for WASM modules ([dev_wasi](/src/dev_wasi))
3. **JSON Interface** — Simplified WASM integration ([dev_json_iface](/src/dev_json_iface))
...
> 📖 Reference: [hb_beamr](/src/hb_beamr) | [hb_beamr_io](/src/hb_beamr_io)
...
- [hb_beamr Reference](/src/hb_beamr) — WASM execution
- [hb_beamr_io Reference](/src/hb_beamr_io) — Memory operations
- [dev_wasm Reference](/src/dev_wasm) — WASM device
- [Full Reference](/hyperbeam) — All modules

**WebAssembly Resources**
- [WebAssembly Specification](https://webassembly.github.io/spec/) — Official spec
- [WAMR](https://github.com/bytecodealliance/wasm-micro-runtime) — The runtime BEAMR uses
- [WAT Format](https://webassembly.github.io/spec/core/text/index.html) — Human-readable WASM

**Building WASM Modules**
- [Rust + wasm-pack](https://rustwasm.github.io/docs/wasm-pack/) — Rust to WASM
