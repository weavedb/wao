...
> 📖 Reference: [hb_crypto](/src/hb_crypto) | [hb_keccak](/src/hb_keccak)
...
> 📖 Reference: [hb_escape](/src/hb_escape)
...
> 📖 Reference: [hb_util](/src/hb_util) | [hb_json](/src/hb_json) | [hb_crypto](/src/hb_crypto)
...
1. **Deep Data Operations** — `hb_util:deep_get/3`, `hb_util:deep_set/4` for nested structures
2. **Statistics** — `hb_util:mean/1`, `hb_util:stddev/1` for performance analysis
3. **Structured Fields** — `hb_structured_fields` for RFC-9651 HTTP headers
4. **Build with HyperBEAM** — These utilities power all HyperBEAM modules ([Book](/book))

---

## Quick Reference Card

> 📖 Reference: [hb_util](/src/hb_util) | [hb_json](/src/hb_json) | [hb_crypto](/src/hb_crypto) | [hb_escape](/src/hb_escape)
...
- [RFC 9651](https://www.rfc-editor.org/rfc/rfc9651.html) — HTTP Structured Fields