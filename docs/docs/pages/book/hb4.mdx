...
> 📖 Reference: [hb_store](/src/hb_store)
...
> 📖 Reference: [hb_store_fs](/src/hb_store_fs)
...
> 📖 Reference: [hb_store_lmdb](/src/hb_store_lmdb)
...
> 📖 Reference: [hb_store_rocksdb](/src/hb_store_rocksdb)
...
> 📖 Reference: [hb_store_lru](/src/hb_store_lru)
...
> 📖 Reference: [hb_store_opts](/src/hb_store_opts)
...
```bash
rebar3 eunit --module=test_hb_store
```
...
1. **Caching Layer** — `hb_cache` builds on storage for content-addressed caching
2. **Remote Storage** — `hb_store_gateway` fetches from Arweave on cache miss
...
> 📖 Reference: [hb_store](/src/hb_store) | [hb_store_fs](/src/hb_store_fs) | [hb_store_lmdb](/src/hb_store_lmdb)
...
- [hb_store Reference](/src/hb_store) — Storage interface
- [hb_store_fs Reference](/src/hb_store_fs) — Filesystem backend
- [hb_store_lmdb Reference](/src/hb_store_lmdb) — LMDB backend
- [hb_store_rocksdb Reference](/src/hb_store_rocksdb) — RocksDB backend
- [hb_store_lru Reference](/src/hb_store_lru) — LRU cache layer
- [hb_store_opts Reference](/src/hb_store_opts) — Configuration defaults
- [Full Reference](/hyperbeam) — All modules

**Backend Documentation**
- [LMDB](http://www.lmdb.tech/doc/) — Lightning Memory-Mapped Database
- [RocksDB](http://rocksdb.org/) — LSM-tree storage engine
- [Erlang ETS](https://www.erlang.org/doc/man/ets.html) — Used by LRU cache

**Related Tutorials**
- [Arweave Utils Tutorial](/book/ar) — Store data permanently on Arweave
- [HyperBEAM Book](/book) — Complete learning path