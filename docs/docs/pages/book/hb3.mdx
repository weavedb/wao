...
> 📖 Reference: [hb_message](/src/hb_message)
...
> 📖 Reference: [hb_singleton](/src/hb_singleton)
...
```bash
rebar3 eunit --module=test_data_structures
```
...
4. **The Full Book** — Continue with [HyperBEAM Book](/book)

---

## Quick Reference Card

> 📖 Reference: [hb_message](/src/hb_message) | [hb_link](/src/hb_link) | [hb_maps](/src/hb_maps) | [hb_singleton](/src/hb_singleton)
...
- [hb_message Reference](/src/hb_message) — Message operations
- [hb_link Reference](/src/hb_link) — Link management
- [hb_maps Reference](/src/hb_maps) — Link-resolving maps
- [hb_singleton Reference](/src/hb_singleton) — TABM parser
- [Full Reference](/hyperbeam) — All modules

**Related Modules**
- [hb_ao](/src/hb_ao) — Core protocol (prefer this for most operations)
- [hb_cache](/src/hb_cache) — Cache storage and retrieval
- [ar_wallet](/src/ar_wallet) — Wallet operations
- [ar_bundles](/src/ar_bundles) — ANS-104 data items

**Tutorials**
- [Arweave Tutorial](/book/ar) — Wallets, data items, and bundles
- [Setup Guide](/book/setup) — Get HyperBEAM running
- [Erlang Crash Course](/book/erlang) — Learn the language