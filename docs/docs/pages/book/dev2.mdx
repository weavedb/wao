...
> 📖 Reference: [dev_codec_httpsig](/src/dev_codec_httpsig)
...
| Sub-device | Purpose |
|------------|---------|
| [dev_codec_httpsig_conv](/src/dev_codec_httpsig_conv) | TABM ↔ HTTP format conversion with multipart support |
| [dev_codec_httpsig_keyid](/src/dev_codec_httpsig_keyid) | Key material extraction (publickey/secret/constant schemes) |
| [dev_codec_httpsig_siginfo](/src/dev_codec_httpsig_siginfo) | Signature ↔ commitment conversion per RFC 9421 |
...
> 📖 Reference: [dev_codec_structured](/src/dev_codec_structured)
...
> 📖 Reference: [dev_codec_json](/src/dev_codec_json)
...
> 📖 Reference: [dev_codec_flat](/src/dev_codec_flat)
...
> 📖 Reference: [dev_codec_httpsig](/src/dev_codec_httpsig) | [dev_codec_structured](/src/dev_codec_structured) | [dev_codec_json](/src/dev_codec_json) | [dev_codec_flat](/src/dev_codec_flat)
...
1. **Infrastructure** — Node and network management ([Tutorial](/book/dev3))
2. **Process & Scheduling** — Stateful computation units ([Tutorial](/book/dev4))
3. **Authentication** — Secrets, wallets, and signing policies ([Tutorial](/book/dev8))
