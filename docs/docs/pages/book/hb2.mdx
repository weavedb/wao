...
> 📖 Reference: [hb_features](/src/hb_features)
...
> 📖 Reference: [hb_private](/src/hb_private)
...
1. **Storage System** — How data is persisted ([hb_store](/src/hb_store))
2. **Message System** — Creating and signing messages ([hb_message](/src/hb_message))
3. **AO Protocol** — The core execution engine ([hb_ao](/src/hb_ao))

---

## Quick Reference Card

> 📖 Reference: [hb_opts](/src/hb_opts) | [hb_features](/src/hb_features) | [hb_private](/src/hb_private) | [hb_path](/src/hb_path)
...
- [hb_opts Reference](/src/hb_opts) — Options system
- [hb_features Reference](/src/hb_features) — Feature flags
- [hb_private Reference](/src/hb_private) — Private state
- [hb_path Reference](/src/hb_path) — Path management
- [Full Reference](/hyperbeam) — All modules

**Related Tutorials**
- [Arweave Primitives](/book/ar) — Wallets, data items, bundles
