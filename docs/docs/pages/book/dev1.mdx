...
> 📖 Reference: [dev_message](/src/dev_message)
...
> 📖 Reference: [dev_stack](/src/dev_stack)
...
> 📖 Reference: [dev_multipass](/src/dev_multipass)
...
> 📖 Reference: [dev_apply](/src/dev_apply)
...
> 📖 Reference: [dev_patch](/src/dev_patch)
...
> 📖 Reference: [dev_dedup](/src/dev_dedup)
...
> 📖 Reference: [dev_message](/src/dev_message) | [dev_stack](/src/dev_stack) | [dev_multipass](/src/dev_multipass) | [dev_apply](/src/dev_apply) | [dev_patch](/src/dev_patch) | [dev_dedup](/src/dev_dedup)
...
1. **Codecs** — Encode/decode messages for wire formats ([Tutorial](/book/dev2))
2. **Process & Scheduling** — Stateful computation units ([Tutorial](/book/dev4))
3. **Runtimes** — Execute WASM and Lua code ([Tutorial](/book/dev6))
