...
HyperBEAM's HTTP server transforms HTTP requests into **messages**, routes them through the **AO-Core resolver**, and converts results back to HTTP responses. It uses [Cowboy](https://github.com/ninenines/cowboy)—Erlang's high-performance HTTP server.
...
> 📖 Reference: [hb_http_server](/src/hb_http_server)
...
> 📖 Reference: [hb_http_server](/src/hb_http_server) | [hb_opts](/src/hb_opts)
...
> 📖 Reference: [hb_http_server](/src/hb_http_server) | [hb_ao](/src/hb_ao)
...
> 📖 Reference: [hb_http_server](/src/hb_http_server) | [dev_hook](/src/dev_hook)
...
Save this as `src/test/test_http_server.erl`:
...
```bash
rebar3 eunit --module=test_http_server
```
...
1. **Devices** — Build custom request handlers ([dev_* modules](/book))
2. **Storage** — Configure persistent backends ([hb_store](/src/hb_store))
3. **AO-Core** — Understand message resolution ([hb_ao](/src/hb_ao))

---

## Quick Reference Card

> 📖 Reference: [hb_http_server](/src/hb_http_server) | [hb_http](/src/hb_http) | [hb_opts](/src/hb_opts)
...
- [hb_http_server Reference](/src/hb_http_server) — HTTP server functions
- [hb_http Reference](/src/hb_http) — HTTP client helpers
- [hb_opts Reference](/src/hb_opts) — Configuration system
- [dev_hook Reference](/src/dev_hook) — Hook system
- [Full Reference](/hyperbeam) — All modules

**Cowboy Documentation**
- [Cowboy User Guide](https://ninenines.eu/docs/en/cowboy/2.12/guide/) — HTTP server framework
- [Cowboy Reference](https://ninenines.eu/docs/en/cowboy/2.12/manual/) — API reference

**Related Tutorials**
- [Arweave Tutorial](/book/ar) — Permanent storage primitives
- [The HyperBEAM Book](/book) — Complete learning path