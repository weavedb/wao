...
> 📖 Reference: [hb_persistent](/src/hb_persistent)
...
> 📖 Reference: [hb_app](/src/hb_app) | [hb_sup](/src/hb_sup) | [hb](/src/hb) | [hb_name](/src/hb_name) | [hb_persistent](/src/hb_persistent)
...
- [hb_app Reference](/src/hb_app) — Application callbacks
- [hb_sup Reference](/src/hb_sup) — Supervisor implementation
- [hb Reference](/src/hb) — Core utilities
- [hb_name Reference](/src/hb_name) — Name registration
- [hb_persistent Reference](/src/hb_persistent) — Worker management
- [Full Reference](/hyperbeam) — All modules

**Erlang/OTP Documentation**
- [Application Behavior](https://www.erlang.org/doc/design_principles/applications.html) — OTP applications
- [Supervisor Behavior](https://www.erlang.org/doc/design_principles/sup_princ.html) — Supervision principles
- [ETS](https://www.erlang.org/doc/man/ets.html) — Erlang Term Storage
- [Process Groups](https://www.erlang.org/doc/man/pg.html) — Distributed process groups