...
> 📖 Reference: [dev_auth_hook](/src/dev_auth_hook)
...
> 📖 Reference: [dev_codec_http_auth](/src/dev_codec_http_auth)
...
> 📖 Reference: [dev_codec_cookie_auth](/src/dev_codec_cookie_auth)
...
> 📖 Reference: [dev_codec_cookie](/src/dev_codec_cookie)
...
> 📖 Reference: [dev_secret](/src/dev_secret)
...
> 📖 Reference: [dev_auth_hook](/src/dev_auth_hook) | [dev_codec_http_auth](/src/dev_codec_http_auth) | [dev_codec_cookie_auth](/src/dev_codec_cookie_auth) | [dev_secret](/src/dev_secret)
...
1. **Arweave & Data** — Permanent storage ([Tutorial](/book/dev9))
