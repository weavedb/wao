...
> 📖 Reference: [dev_meta](/src/dev_meta)
...
> 📖 Reference: [dev_router](/src/dev_router)
...
> 📖 Reference: [dev_relay](/src/dev_relay)
...
> 📖 Reference: [dev_node_process](/src/dev_node_process)
...
> 📖 Reference: [dev_hook](/src/dev_hook)
...
> 📖 Reference: [dev_meta](/src/dev_meta) | [dev_router](/src/dev_router) | [dev_relay](/src/dev_relay) | [dev_node_process](/src/dev_node_process) | [dev_hook](/src/dev_hook)
...
1. **Process & Scheduling** — Stateful computation units ([Tutorial](/book/dev4))
2. **Store** — Data persistence and caching ([Tutorial](/book/dev5))
